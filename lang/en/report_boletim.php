...
$string['statusconfig'] = 'Boletim Consolidado Settings';
...
$string['coursesheader'] = 'Displayed courses configuration';
$string['courselistmode'] = 'Which courses should appear in the report?';
